// This is an  optimized nbody code simulation without MPI multiprocessing
// This is the reference code to verifying results with and without MPI. Files named 
// 3x.txt and 3v.txt are the positions and velocities of the first particule during the simulation.
// Theses solutions are coherents with a naive nbody simulation. 
...
int main(int argc, char **argv)
{
	...
	#ifdef SAVE
		FILE *xfilePtr = NULL ; 
		xfilePtr = fopen("3x.txt", "w");
		FILE *vfilePtr = NULL ; 
		vfilePtr = fopen("3v.txt", "w");		
